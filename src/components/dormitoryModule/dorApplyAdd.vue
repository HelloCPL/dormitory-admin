  ...
  <div class="add-box">
    <el-form ref="formName" :rules="rules" :model="dataInfo" label-position="left" label-width="100px" class="we-flex-wrap we-padding">
      <el-form-item label="申请内容" prop="content" class="we-width-100pc">
        <el-input v-model="dataInfo.content" type="textarea" rows="2" placeholder="请输入申请内容" disabled clearable></el-input>
      </el-form-item>
      <el-form-item label="申请原因" prop="reason" class="we-width-100pc">
        <el-input v-model="dataInfo.reason" type="textarea" rows="2" placeholder="请输入申请原因" disabled clearable></el-input>
      </el-form-item>
